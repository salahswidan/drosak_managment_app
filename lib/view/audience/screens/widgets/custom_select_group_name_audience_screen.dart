...
class CustomSelectGroupNameAudienceScreen extends StatelessWidget {
  const CustomSelectGroupNameAudienceScreen(
      {super.key,
      ...
      child: Column(
        children: [
          StreamBuilder2<List<GroupDetails>, GroupDetails?>(
            streams: StreamTuple2(outPutDataListItemGroupsDetails,
